...
<div class="modal fade" id="signupModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    ...
    <div class="container my-5 legal-tips">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="https://images.unsplash.com/photo-1555374018-13a8994ab246" alt="Legal Tips">
            </div>
            <div class="col-md-6">
                <h3 class="mb-3">Helpful Legal Tips</h3>
                <ul>
                    <li>Know when to consult a lawyer.</li>
                    <li>Always check a lawyer's credentials.</li>
                    <li>Use LEXASK to book a consultation in minutes.</li>
                    <li>Keep your documents ready and organized.</li>
                </ul>
            </div>
        </div>
    </div>
    <!-- Legal Tips Section -->
    <section class="legal-tips-section py-5 bg-white text-center">
    <div class="container">
        <h2 class="mb-5">📝 Legal Tips</h2>
        <div class="row g-4">
        
        <!-- Tip 1 -->
        <div class="col-md-6">
            <div class="tip-card p-4 h-100 shadow-sm border rounded hover-effect">
            <h4>⏰ When to Find a Lawyer?</h4>
            <p class="mt-3">
...
<div class="modal fade" id="loginModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="index.php">
                    ...
                    <a href="forgot_password.php" class="d-block mb-3 text-decoration-none">Forgot password?</a>
    ...
    <div class="container">
        ...
        <div class="col-md-4 mb-4">
            ...
            <p><i class="fas fa-map-marker-alt"></i> 123 Legal St, Dhaka, Bangladesh</p>
            <p><i class="fas fa-phone"></i> +880 123-456-789</p>
            <p><i class="fas fa-envelope"></i> support@lexask.com</p>
        </div>
